  ...
  return (
    <div className="pt-20 mt-10 mb-8 md:my-16 md:grid md:grid-cols-12">
      <div className="profile-pic col-span-5 place-self-center">
        <img
          src={assets.hero}
          className="p-4 rounded-full md:w-[400px] lg:w-[90%] "
          alt="My Pic"
        />
      </div>
      <div className="Bio md:col-span-5 flex flex-col gap-4 text-start justify-center py-8 md:py-15 md:px-10 ">
        ...
        <p className="font-bold md:text-4xl text-3xl">Nemmani Upendhar</p>
        <p className="font-medium md:text-3xl text-2xl">Software Engineer</p>
        <p>Based in Hyderabad, India</p>
        <a
          href="https://drive.google.com/file/d/1JPCItoRHbOl5fNjw83qBsUZUPiTKwJ6d/view?usp=sharing"
          target="_blank"
          className="p-2 w-[50%] md:w-[15vw] rounded-xl font-bold text-white bg-black hover:scale-110 hover:transition text-center"
        >
          View Resume
        </a>
      </div>
      <div className="sm:hidden flex absolute right-2 bottom-[22%] flex-col gap-8 justify-center text-4xl">
        <a
      ...
      <div className="hidden md:flex flex-col md:colspan-2 gap-14 justify-center items-center text-4xl">
        <a
          href="https://www.linkedin.com/in/upendharnemmani"
          target="_blank"
          className="hover:scale-110 hover:transition-all"
